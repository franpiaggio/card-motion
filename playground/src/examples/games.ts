...
export const GAMES: ReadonlyArray<GameCard> = [
  { href: '#/spider', name: 'Spider', tag: 'Auto play', accent: 'coral', blurb: 'Ten columns; build and clear King→Ace runs. Every deal is pre-validated winnable, and Auto play replays the solved line.', uses: 'DragDropProvider · DropZone · DraggableCard · solver' },
